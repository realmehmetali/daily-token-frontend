...
export const ACTION_VERIFY = process.env.NEXT_PUBLIC_WORLD_ID_ACTION_VERIFY || "action_connect";
export const ACTION_CLAIM = process.env.NEXT_PUBLIC_WORLD_ID_ACTION_CLAIM || "action_claim";
